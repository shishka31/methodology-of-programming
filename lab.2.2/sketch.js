...
function setup() {
    ...
    restartButton.position(width / 2 - 18, height / 2 + 40);
...
function draw() {
    if(score > -6) {
        ...
        deathSe.setVolume(sliderValue * 0.8);  
        killSe.setVolume(sliderValue * 0.8);
        waterSplash.setVolume(sliderValue * 5);
        ...
        textSize(15);
        text(score, 480, 30);
        text("Press M to toggle music", 480, 50);
        if (!backPlay) {
